...
export default function ConfirmPage(props) {
    ...
    const answer = props.answers.reduce(function (acc, e) { acc[e] = (e in acc ? acc[e] + 1 : 1); return acc }, {});
                    ...
                    return (
                        <Box>
                            ...
                            <Box className={classes.footer}>
                                <Button type="submit" variant="contained" color="primary" onClick={handleSubmit} >Recomeçar</Button>
                            </Box>
                        </Box>
                    )
                }
